...
public class ControlQualityTest {
    ...
    public void addToWarehouse() {
        ...
        assertTrue(new ControlQuality(List.of(new Warehouse())).execute(food));
    }
    ...
    public void addToShop() {
        ...
        assertTrue(new ControlQuality(List.of(new Shop())).execute(food));
    }
    ...
    public void addToTrash() {
        ...
        assertTrue(new ControlQuality(List.of(new Trash())).execute(food));
    }
    ...
    public void findAll() {
        ...
        new ControlQuality(List.of(shop)).execute(food);
