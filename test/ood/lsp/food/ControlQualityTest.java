...
public class ControlQualityTest {
    ...
    public void findByName() {
        ...
        List<Food> expected = List.of(
                finder.findByName(warehouse.getProducts(), "Banana Warehouse").get(0),
                finder.findByName(shop.getProducts(), "Banana Shop").get(0),
                finder.findByName(trash.getProducts(), "Banana Trash").get(0)
        );
        assertEquals(food, expected);
    }
    ...
    public void whenAddToShopWithDiscount() {
        ...
        Food getFood = new FinderFood().findByName(shop.getProducts(), "Banana Shop with discount").get(0);
